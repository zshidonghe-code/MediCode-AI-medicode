# 码医 MediCode · AI 医疗 DRG 编码与病历质控系统 | 准确率 95%+ | 2026
...
**核心差异化优势：** "编码 + DRG 分组 + 质控 + 拒付预测" 四合一，市场上没有同类一体化产品。
...
基于 **920 条 ICD-10 诊断 + 611 条 ICD-9-CM-3 手术**的标准测试集，对比人工编码金标准计算 **Top-5 推荐准确率**。
- 无 LLM 模式（纯规则 + 向量搜索）：80%
- LLM 增强模式（Qwen2.5:3B）：**95%+**

测试集和报告详见 `docs/BENCHMARK_REPORT.md`。

### 和市面上的单独编码系统、DRG 系统有什么区别？

**码医 MediCode 是行业首个"编码 + DRG 分组 + 质控 + 拒付预测"四合一平台**。一套系统解决 DRG 改革全流程痛点，区别于市面上的单一工具（详见上方"为什么选择码医"对比表）。
...
| [docs/BENCHMARK_REPORT.md](docs/BENCHMARK_REPORT.md) | 编码准确率基准测试报告 |
